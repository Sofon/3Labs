...
begin
  ...
  if (a>0.517) or (b<0.5179) then ShowMessage('Искомый корень лежит вне отрезка') else
...
begin
   ...
   then begin ShowMessage('Должно быть соблюдено неравенство: 0,01<=A<B<=1,99');
   Edit1.Text:='0,01'; Edit2.Text:='1,99'; end
  except
    ShowMessage('Должно быть введено число, или стоит . вместо ,');
